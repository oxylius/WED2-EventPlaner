...
define(["require", "exports"], function (require, exports) {
    define(['app/services/uuidService'], function (UUIDService) {
        ...
        Event.createFromDTO = function (jsonData) {
            return new Event(jsonData.name, jsonData.description, jsonData.targetGroup, jsonData.eventGift, jsonData.location, jsonData.times, jsonData.maximalAmoutOfGuests, jsonData.id);
        };
        return Event;
    });
});
